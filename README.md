...
```javascript
geometric = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-geometric@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-geometric@v0.3.0-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-geometric/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/stats-base-dists-geometric/actions/workflows/test.yml?query=branch:v0.3.0
